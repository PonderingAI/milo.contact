...
export default async function HeroSection({ latestProject }: HeroSectionProps) {
  ...
  let backgroundMedia = settings.image_hero_bg || "/images/hero-bg.jpg"

  if (settings.hero_bg_type === "latest_project" && latestProject) {
    // Use the latest project's video or image
    backgroundMedia = latestProject.thumbnail_url || latestProject.image || backgroundMedia
  }
    ...
    <section className="relative h-screen overflow-hidden">
      ...
      {isVideo && backgroundMedia ? (
        ...
        <div
          ...
          style={{ backgroundImage: `url(${backgroundMedia || "/images/hero-bg.jpg"})` }}
        >
      ...
      <div className="absolute bottom-8 left-8 z-10 max-w-md text-left">
        <h1
          className={`text-3xl md:text-4xl font-bold mb-2 ${fontSerif.variable} font-serif`}
